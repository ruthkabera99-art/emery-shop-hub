...
// AI-powered smart auto-reply via edge function (uses admin training entries)
const getSmartReply = async (text: string, history: { role: "user" | "assistant"; content: string }[]): Promise<string> => {
  try {
    ...
    console.error("[LiveChat] smart reply failed", e);
